...
pajhwokApp.config(['$routeProvider,$locationProvider',
...
//        mapTypeId: google.maps.MapTypeId.ROADMAP
    ...
    $scope.managemarker2 = function (cat, subcat, lang, search) {
        ...
        query.columns = ["_id", "media", "title", "category" , "location", "cityid","cityid.en_fullname","cityid.ps_fullname","cityid.dr_fullname", "cityid.location", "__createdon"];
...
pajhwokApp.controller('articleCtrl', function ($scope, $compile, $http, $location, $appService, $rootScope, $routeParams, $window) {
    $scope.$on('$viewContentLoaded', function (event) {
        $window._gaq.push(['_trackPageview', $location.path()]);
         ...
         console.log("im in article ctrl");
